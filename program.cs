...
namespace Consoleproject
{
    class Program
    {
        static void Main(string[] args)
        {
           ...
           HumanResourceManager humanResourceManager = new HumanResourceManager();
            ...
            do
            {
                ...
                Console.WriteLine("Yerine Yetirmek Isdediyniz Emeliyyatin  Nomresini Daxil Edin:");
        ...
        private static void DepartmentOperation(ref IHumanResourceManager humanResourceManager)
        {
